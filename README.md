...
```
curl -L https://github.com/gimlet-io/gimlet-stack/releases/download/v0.3.1/stack-$(uname)-$(uname -m) -o stack
chmod +x stack
...
Please check the [v0.3.1](https://github.com/gimlet-io/gimlet-stack/projects/2) project and see if you are interested to help.
